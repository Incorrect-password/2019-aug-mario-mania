...
# Generation Time: 2019-12-12 09:39:43 +0000
# ************************************************************
...
CREATE TABLE `race` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Race` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
VALUES
	(1,'2019-12-01 12:00:00'),
	(2,'2019-12-01 12:30:00'),
	(3,'2019-12-01 12:45:00'),
	(4,'2019-12-01 13:45:00');
